...
begin
	case(LUT_INDEX)
        ...
        SET_OV7670 + 0 	: 	LUT_DATA	= 	16'h1214;  // Register COM7;  0001 (Output QVGA), 0100 (Output RGB) default: 1214
    	SET_OV7670 + 1 	: 	LUT_DATA	= 	16'h40d0;  // Register COM15:  00 (Range 00 to FF), 01 (RGB 565)	
    	SET_OV7670 + 2 	: 	LUT_DATA	= 	16'h3a04;	//set fixed uv values: default: 3a04
    	SET_OV7670 + 3 	: 	LUT_DATA	=	16'h3dc8; // gamma enable: default: 3dc8
    	...
    	SET_OV7670 + 41 : 	LUT_DATA	= 	16'ha505; // 50 Hz Banding Filter Max
    	SET_OV7670 + 42 : 	LUT_DATA	= 	16'hab07; // 60 Hz Banding Filter Max
    	...
    	SET_OV7670 + 69	: 	LUT_DATA	= 	16'h690c; //default: 6900
    	...
    	SET_OV7670 + 105 :	LUT_DATA	=	16'h6a40; // AWB green  gain
    	SET_OV7670 + 106 :	LUT_DATA	=	16'h0140; // AWB blue gain
    	SET_OV7670 + 107 :	LUT_DATA	=	16'h0240; //AWB red gain
    	...
    	SET_OV7670 + 117 : 	LUT_DATA	=	16'h4108; // edge enhancement default: 4108
    	SET_OV7670 + 118 : 	LUT_DATA	=	16'h3f00; // '' default: 3f00
    	SET_OV7670 + 119 : 	LUT_DATA	=	16'h7505; // '' default: 7505
    	SET_OV7670 + 120 : 	LUT_DATA	=	16'h76e1; // '' default: 76e1
    	SET_OV7670 + 121 : 	LUT_DATA	=	16'h4c00;
    	SET_OV7670 + 122 : 	LUT_DATA	=	16'h7701;
    	
    	SET_OV7670 + 123 : 	LUT_DATA	=	16'h4b09;
    	SET_OV7670 + 124 : 	LUT_DATA	=	16'hc900; // saturation, default: c9f0
    	SET_OV7670 + 125 : 	LUT_DATA	=	16'h4138;
    	SET_OV7670 + 126 : 	LUT_DATA	=	16'h5640; // contrast default: 5640
