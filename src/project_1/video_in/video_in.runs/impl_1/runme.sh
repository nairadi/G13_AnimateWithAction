...
HD_PWD='W:/ECE532/project_1/video_in/video_in.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log video_in.vdi -applog -m64 -messageDb vivado.pb -mode batch -source video_in.tcl -notrace
